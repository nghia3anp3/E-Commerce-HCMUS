...
const spdRouter = express.Router();
const {getData,getDataByID} = require('../../controllers/laptop/specific_data.controller.js');

//Get
spdRouter.get('/', getData);
spdRouter.get("/:product_id", getDataByID);

module.exports = spdRouter;
...
// const col = "Laptop_specific_info"
